...
const Card = (props: Props) => {
  ...
  return (
    <div className="relative">
      <Link className={`absolute z-10 -right-2 -top-2 bg-black rounded-full ${props.githubUrl===undefined&&'cursor-not-allowed pointer-events-none '}`} href={props.githubUrl?props.githubUrl:'#'} target="_blank">
