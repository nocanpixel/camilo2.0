...
export const Navbar = () => {
    ...
    return(
        <section className="flex px-6 lg:px-40 absolute z-40 justify-between items-center h-20 bg-black w-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0">
