  ...
  return (
    <main>
      <section className="h-screen relative">
        <div
          className="
        absolute right-0 z-10 bg-white p-2 rounded-md flex gap-3 items-center
        "
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-black text-xs w-96">
              {
        ...
        <Background />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-3/4 text-center w-96 md:w-full">
